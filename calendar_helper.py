...
SA_JSON = os.getenv("GOOGLE_SERVICE_ACCOUNT_JSON") or ""
...
def create_booking(phone: str, service_name: str, start_dt: datetime, minutes: int = 30) -> str:
    if not CALENDAR_ID:
        return "CALENDAR_NOT_SET"
    service = _svc()
