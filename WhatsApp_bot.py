...
# Map service name -> (price, minutes)
...
def call_openai_json(user_text: str):
    ...
    system = (
        ...
        f"Return services as words the user said (can be fuzzy like 'fade', 'brows').\n"
        f"If no datetime phrase is present, datetime_text must be null."
    )
